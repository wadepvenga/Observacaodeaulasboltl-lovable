...
import { EvaluationResult, ADULTS_CHECKLIST, TEENS_CHECKLIST, Method } from '../types';
import { FiCheck, FiX, FiAward, FiClipboard, FiFileText, FiList } from 'react-icons/fi';
                  ...
                  {section.items.map((item) => {
                    ...
                    return (
                      <div
                        ...
                        className="group flex items-center p-4 rounded-xl transition-all duration-300 cursor-pointer
